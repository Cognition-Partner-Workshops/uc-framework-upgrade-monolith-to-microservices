...
-- Comments have been extracted to the standalone comments microservice, which owns
-- the comments table and its seed data (see comments-service/src/main/resources/db/migration).
