...
public class CommentMutation {
  ...
  public DataFetcherResult<CommentPayload> createComment(
    ...
    CommentServiceClient.CommentResponse created =
  ...
  public DeletionStatus removeComment(
    ...
    return commentServiceClient
        .getCommentByArticleIdAndId(article.getId(), commentId)
        .map(
            comment -> {
  ...
  private boolean canWriteComment(
      User user, Article article, CommentServiceClient.CommentResponse comment) {
