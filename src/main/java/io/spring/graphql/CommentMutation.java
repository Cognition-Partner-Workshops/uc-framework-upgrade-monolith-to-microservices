...
public class CommentMutation {
  ...
  public DataFetcherResult<CommentPayload> createComment(
    ...
    Comment comment = commentServiceClient.createComment(body, user.getId(), article.getId());
    CommentData commentData =
        commentQueryService
            .findById(comment.getId(), article.getId(), user)
  ...
  public DeletionStatus removeComment(
    ...
    return commentServiceClient
        .getCommentByIdAndArticleId(article.getId(), commentId)
        .map(
            comment -> {
