...
public class ArticleMutationTest {
  ...
  @Test
  void should_throw_when_updating_article_unauthorized() {
    User anotherUser = new User("other@test.com", "other", "pass", "", "");
    Article otherArticle =
        new Article("Other", "desc", "body", Collections.emptyList(), anotherUser.getId());
  ...
  @Test
  void should_throw_when_deleting_article_unauthorized() {
    User anotherUser = new User("other@test.com", "other", "pass", "", "");
    Article otherArticle =
        new Article("Other", "desc", "body", Collections.emptyList(), anotherUser.getId());
    when(articleRepository.findBySlug(eq(otherArticle.getSlug())))
  ...
  @Test
  void should_throw_when_deleting_unauthenticated() {
    setAnonymousAuth();
