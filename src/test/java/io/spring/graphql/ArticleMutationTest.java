...
public class ArticleMutationTest {
  ...
  void should_update_article_success() {
    UpdateArticleInput changes =
        UpdateArticleInput.newBuilder().title("Updated Title").body("new body").build();
  ...
  void should_fail_update_article_when_not_found() {
    ...
    assertThrows(
        ...
        () ->
            articleMutation.updateArticle("nonexistent", UpdateArticleInput.newBuilder().build()));
  }
    ...
    assertThrows(
        ...
        () ->
            articleMutation.updateArticle(
                otherArticle.getSlug(), UpdateArticleInput.newBuilder().build()));
  }
  ...
  @Test
  void should_fail_favorite_when_not_authenticated() {
    setAnonymous();
    assertThrows(
  ...
  @Test
  void should_fail_delete_article_when_not_authenticated() {
    setAnonymous();
    assertThrows(
