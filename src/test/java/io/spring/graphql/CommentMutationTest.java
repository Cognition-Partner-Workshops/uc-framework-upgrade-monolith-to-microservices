...
public class CommentMutationTest {
  ...
  public void should_create_comment_success() {
    ...
    var result = commentMutation.createComment(article.getSlug(), "comment body");
  ...
  @Test
  public void should_throw_authentication_when_creating_comment_unauthenticated() {
  ...
  @Test
  public void should_throw_not_found_when_comment_data_not_found_after_save() {
    when(articleRepository.findBySlug(eq(article.getSlug()))).thenReturn(Optional.of(article));
  ...
  @Test
  public void should_throw_no_authorization_when_deleting_others_comment() {
  ...
  @Test
  public void should_throw_not_found_when_article_not_found_for_delete_comment() {
    when(articleRepository.findBySlug(eq("nonexistent"))).thenReturn(Optional.empty());
  ...
  @Test
  public void should_throw_authentication_when_deleting_comment_unauthenticated() {
    SecurityContextHolder.getContext()
        .setAuthentication(
            new AnonymousAuthenticationToken(
                "key", "anonymousUser", AuthorityUtils.createAuthorityList("ROLE_ANONYMOUS")));
