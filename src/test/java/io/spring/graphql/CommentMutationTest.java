...
public class CommentMutationTest {
  ...
  @Test
  void should_fail_delete_comment_when_not_authenticated() {
    setAnonymous();

    assertThrows(
        AuthenticationException.class,
        () -> commentMutation.removeComment(article.getSlug(), "commentId"));
  }
  ...
  void should_fail_delete_comment_when_article_not_found() {
    ...
    assertThrows(
        ...
        () -> commentMutation.removeComment("missing", "commentId"));
  }
  ...
  @Test
  void should_fail_delete_comment_when_not_author() {
    User articleOwner = new User("owner@test.com", "owner", "pass", "", "");
    User commentAuthor = new User("commenter@test.com", "commenter", "pass", "", "");
    Article otherArticle = new Article("Other", "d", "b", Arrays.asList(), articleOwner.getId());
