...
public class UserMutationTest {
  ...
  @Test
  void should_return_errors_when_creating_user_with_constraint_violation() {
    CreateUserInput input =
        CreateUserInput.newBuilder().email("invalid").username("").password("password").build();
  ...
  void should_throw_when_login_with_nonexistent_email() {
    ...
    assertThrows(
        ...
        () -> userMutation.login("password", "nobody@test.com"));
  }
