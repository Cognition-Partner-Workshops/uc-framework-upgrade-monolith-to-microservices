...
public class ArticleDatafetcherTest {
  ...
  public void setUp() {
    ...
    ProfileData profile = new ProfileData(user.getId(), "testuser", "bio", "image", false);
    articleData =
        new ArticleData(
            "id1",
            "test-article",
  ...
  @Test
  public void should_throw_not_found_when_article_not_found_by_slug() {
  ...
  public void should_get_feed_with_first_param() {
    CursorPager<ArticleData> pager =
        new CursorPager<>(new ArrayList<>(Arrays.asList(articleData)), Direction.NEXT, false);
  ...
  public void should_get_feed_with_last_param() {
    CursorPager<ArticleData> pager =
        new CursorPager<>(new ArrayList<>(Arrays.asList(articleData)), Direction.PREV, false);
    DgsDataFetchingEnvironment dfe = mock(DgsDataFetchingEnvironment.class);
  ...
  @Test
  public void should_throw_when_feed_first_and_last_null() {
    DgsDataFetchingEnvironment dfe = mock(DgsDataFetchingEnvironment.class);
    assertThrows(
  ...
  @Test
  public void should_throw_when_user_feed_first_and_last_null() {
    DgsDataFetchingEnvironment dfe = mock(DgsDataFetchingEnvironment.class);
    assertThrows(
        IllegalArgumentException.class,
  ...
  public void should_get_articles_with_first_param() {
    ...
    var result = articleDatafetcher.getArticles(10, null, null, null, null, null, null, dfe);
  ...
  public void should_get_articles_with_last_param() {
    ...
    var result = articleDatafetcher.getArticles(null, null, 10, null, null, null, null, dfe);
  ...
  @Test
  public void should_get_articles_with_empty_result() {
  ...
  public void should_get_article_payload() {
    io.spring.core.article.Article article =
        new io.spring.core.article.Article(
            "Test Article", "desc", "body", Arrays.asList("java"), user.getId());
  ...
  @Test
  public void should_throw_not_found_for_article_payload_when_not_found() {
    io.spring.core.article.Article article =
        new io.spring.core.article.Article(
            "Test Article", "desc", "body", Arrays.asList("java"), user.getId());
    DataFetchingEnvironment dfe = mock(DataFetchingEnvironment.class);
  ...
  public void should_get_comment_article() {
    DateTime now = new DateTime();
    ProfileData profile = new ProfileData(user.getId(), "testuser", "bio", "image", false);
    CommentData commentData = new CommentData("cid", "body", "articleId", now, now, profile);
  ...
  @Test
  public void should_throw_not_found_for_comment_article_when_not_found() {
    DateTime now = new DateTime();
    ProfileData profile = new ProfileData(user.getId(), "testuser", "bio", "image", false);
    CommentData commentData = new CommentData("cid", "body", "articleId", now, now, profile);
    ...
    DataFetchingEnvironment dfe = mock(DataFetchingEnvironment.class);
    doReturn(commentData).when(dfe).getLocalContext();
    when(articleQueryService.findById(eq("articleId"), eq(user))).thenReturn(Optional.empty());
