...
public class ArticleDatafetcherTest {
  ...
  @Test
  void should_throw_when_user_feed_target_not_found() {
  ...
  @Test
  void should_get_article_payload_article() {
    setAuthenticated(user);
  ...
  @Test
  void should_throw_not_found_when_article_payload_article_missing() {
    setAuthenticated(user);
    io.spring.core.article.Article coreArticle =
        new io.spring.core.article.Article(
            "Test Title", "desc", "body", Arrays.asList("java"), user.getId());
  ...
  @Test
  void should_throw_not_found_when_comment_article_missing() {
    setAuthenticated(user);
    CommentData commentData =
        new CommentData(
            "cid",
