...
public class TagsApiTest extends TestWithCurrentUser {
  ...
  @Test
  public void should_get_tag_stats_without_login() throws Exception {
    when(tagsQueryService.tagStats())
        .thenReturn(Arrays.asList(new TagStatsData("java", 2), new TagStatsData("spring", 1)));
    ...
    RestAssuredMockMvc.when()
        ...
        .body("tags[0].articleCount", equalTo(2));
  }
}
