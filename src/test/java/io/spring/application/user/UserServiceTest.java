...
public class UserServiceTest {
  ...
  void should_update_user() {
    User user = new User("old@test.com", "olduser", "password", "bio", "image");
  ...
  @Test
  void should_update_user_partial_fields() {
    User user = new User("old@test.com", "olduser", "password", "bio", "image");
    UpdateUserParam updateParam = UpdateUserParam.builder().email("new@test.com").build();
    UpdateUserCommand command = new UpdateUserCommand(user, updateParam);
