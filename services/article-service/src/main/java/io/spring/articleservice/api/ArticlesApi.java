...
public class ArticlesApi {
  ...
  public ResponseEntity getFeed(
    ...
    return ResponseEntity.ok(articleQueryService.findUserFeed(user, offset, limit));
  }
  ...
  public ResponseEntity getArticles(
      ...
      @AuthenticationPrincipal User user) {
    return ResponseEntity.ok(
        articleQueryService.findRecentArticles(tag, author, favoritedBy, offset, limit, user));
  }
}
