package com.bank.rm.projection.config;

import com.bank.rm.common.security.JwtAuthFilter;
import com.bank.rm.common.security.JwtUtil;
import com.bank.rm.projection.service.MonteCarloEngine;
...
public class ProjectionConfig {
    ...
    @Bean
    public MonteCarloEngine monteCarloEngine() { return new MonteCarloEngine(); }
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/api/v1/projections/**").permitAll()
