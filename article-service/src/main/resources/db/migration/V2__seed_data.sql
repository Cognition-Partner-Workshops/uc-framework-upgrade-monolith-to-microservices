...
-- Insert sample articles (user_id references users in the monolith)
...
('comment-2', 'Very helpful article on REST best practices.', 'article-2', 'user-1', datetime('now', '-4 days'), datetime('now', '-4 days')),
('comment-3', 'I learned a lot about microservices from this.', 'article-3', 'user-3', datetime('now', '-2 days'), datetime('now', '-2 days')),
('comment-4', 'Docker makes deployment so much easier!', 'article-4', 'user-1', datetime('now', '-1 days'), datetime('now', '-1 days')),
('comment-5', 'Testing is often overlooked. Thanks for this guide!', 'article-5', 'user-3', datetime('now'), datetime('now'));
